...
- chore(deps): bump eslint-plugin-react-refresh from 0.5.5 to 0.5.6 in /smart_vent/frontend ([#623](https://github.com/dhruvb14/smart-thermostat-with-vents/pull/623))
