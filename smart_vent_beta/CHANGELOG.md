...
## 0.36.0-beta.4 — building toward v0.36.0
...
> heading for the next stable release (v0.36.0).

**Landed on beta since v0.35.0:**
...
- chore(deps): bump @testing-library/user-event from 14.6.4 to 14.6.6 in /smart_vent/frontend ([#571](https://github.com/dhruvb14/smart-thermostat-with-vents/pull/571))
