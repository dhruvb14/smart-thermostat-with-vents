...
## 0.36.0-beta.7 — building toward v0.36.0
...
- chore(deps): bump eslint-plugin-react-refresh from 0.5.4 to 0.5.5 in /smart_vent/frontend ([#590](https://github.com/dhruvb14/smart-thermostat-with-vents/pull/590))
