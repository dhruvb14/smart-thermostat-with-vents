...
> heading for the next stable release (v0.38.0).
...
- chore(deps): bump typescript-eslint from 8.69.0 to 8.70.0 in /smart_vent/frontend ([#645](https://github.com/dhruvb14/smart-thermostat-with-vents/pull/645))
