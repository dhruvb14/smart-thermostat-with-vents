...
- chore(deps): bump @testing-library/user-event from 14.6.6 to 14.6.7 in /smart_vent/frontend ([#620](https://github.com/dhruvb14/smart-thermostat-with-vents/pull/620))
