...
## 0.36.0-beta.2 — building toward v0.36.0
...
- chore(deps): bump @testing-library/user-event from 14.6.3 to 14.6.4 in /smart_vent/frontend ([#564](https://github.com/dhruvb14/smart-thermostat-with-vents/pull/564))
