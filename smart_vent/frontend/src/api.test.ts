...
describe("API Client", () => {
  ...
  it("createRoom sends a POST request", async () => {
    ...
    const payload = { name: "New Room" } as any;
  ...
  it("updateRoom sends a PUT request", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/1", expect.objectContaining({
      method: "PUT",
  ...
  it("addSensor calls the correct sub-resource", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/sensors", expect.objectContaining({
      method: "POST",
  ...
  it("removeSensor calls the correct sub-resource with DELETE", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/sensors/s1", expect.objectContaining({
      method: "DELETE",
    }));
  });
  ...
  it("addVent sends control_method", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/vents", expect.objectContaining({
  ...
  it("updateVentControlMethod uses PATCH", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/vents/v1", expect.objectContaining({
      method: "PATCH",
  ...
  it("testVent sends a POST to /api/vents/test", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/vents/test", expect.objectContaining({
      method: "POST",
  ...
  it("addPresence adds a presence sensor", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/presence", expect.objectContaining({
      method: "POST",
    }));
  });
  ...
  it("removePresence removes a presence sensor", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/presence/p1", expect.objectContaining({
      method: "DELETE",
    }));
  });
  ...
  it("setOverride sets a temporary override", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/override", expect.objectContaining({
  ...
  it("createSchedule sends a POST request", async () => {
    mockJsonResponse({});
    await api.createSchedule("r1", { start_time: "10:00", end_time: "11:00", days_of_week: [1], target_temp: 70 });
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/schedules", expect.objectContaining({
      method: "POST",
    }));
  });
  ...
  it("updateSchedule sends a PUT request", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/r1/schedules/s1", expect.objectContaining({
      method: "PUT",
    }));
  });
  ...
  it("createThermostat sends a POST request", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/thermostats", expect.objectContaining({
      method: "POST",
    }));
  });
  ...
  it("updateThermostat sends a PUT request", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/thermostats/climate.test", expect.objectContaining({
      method: "PUT",
    }));
  });
  ...
  it("clearEventLogs sends a DELETE request", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/logs/events", expect.objectContaining({
      method: "DELETE",
    }));
  });
  ...
  it("setLogRetention sends a POST request", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/settings/log-retention", expect.objectContaining({
      method: "POST",
    }));
  });
  ...
  it("setSystemEnabled toggles system", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/system/enabled", expect.objectContaining({
      method: "POST",
  ...
  it("getRoomActiveStatuses sends a POST", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/rooms/active-status", expect.objectContaining({
      method: "POST",
  ...
  it("setOutsideTempEntity sends a PUT", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/settings/outside-temp-entity", expect.objectContaining({
      method: "PUT",
  ...
  it("triggerDailyRollup sends a POST", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/metrics/rollup/daily", expect.objectContaining({
      method: "POST",
